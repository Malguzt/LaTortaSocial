<div class="posts index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('narration'); ?></th>
			<th><?php echo $this->Paginator->sort('notes'); ?></th>
			<th><?php echo $this->Paginator->sort('dice'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($post['Post']['narration']); ?>&nbsp;</td>
		<td><?php echo h($post['Post']['notes']); ?>&nbsp;</td>
		<td><?php echo h($post['Post']['dice']); ?>&nbsp;</td>
		<td>
